...
public sealed class AnalysisExceptionLengthIndependenceTests
{
    ...
    public static TheoryData<string, Func<int, Exception>> UnboundedGrowthAxes() => new()
    {
        ...
        { "NoSuchStructField/reference", n => AnalysisException.NoSuchStructField(Pad(n), "no such field") },
        { "NoSuchStructField/detail", n => AnalysisException.NoSuchStructField("s.f", Pad(n)) },
        { "AmbiguousStructField/reference", n => AnalysisException.AmbiguousStructField(Pad(n), "ambiguous field") },
        { "AmbiguousStructField/detail", n => AnalysisException.AmbiguousStructField("s.f", Pad(n)) },
        { "InvalidExtractBase/reference", n => AnalysisException.InvalidExtractBase(Pad(n), "need a struct") },
        { "InvalidExtractBase/detail", n => AnalysisException.InvalidExtractBase("s.f", Pad(n)) },
        { "InvalidColumnName/name", n => AnalysisException.InvalidColumnName(Pad(n)) },
