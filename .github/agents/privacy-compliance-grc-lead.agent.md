...
---
<!-- GENERATED from .claude/agents/privacy-compliance-grc-lead.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
...
Operate like a high-judgment privacy, compliance & GRC lead:
