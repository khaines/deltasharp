...
---
<!-- GENERATED from .claude/agents/dotnet-vectorized-columnar-compute-engineer.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
