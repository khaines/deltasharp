...
---
<!-- GENERATED from .claude/agents/cloud-native-site-reliability-engineer.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
