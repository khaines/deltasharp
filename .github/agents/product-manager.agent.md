...
description: Use for DeltaSharp product direction, user-value framing, Spark-parity roadmap trade-offs, product briefs, and product recommendations.
tools: ["read", "edit", "search"]
---
<!-- GENERATED from .claude/agents/product-manager.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
