<!-- GENERATED from .claude/skills/implement-work-item/build-test-config.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
