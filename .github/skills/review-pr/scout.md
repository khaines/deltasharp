<!-- GENERATED from .claude/skills/review-pr/scout.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
...
- Model: a cheap tier. The scout only **routes** — it never scores or gates — so its model is
