<!-- GENERATED from .claude/skills/review-fix-loop/dismissal-rules.md by tools/aiconfig/generate-copilot.py — do not edit; edit the source and re-run with --write. -->
