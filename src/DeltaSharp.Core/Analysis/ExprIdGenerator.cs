...
/// fresh counter at the start of every <see cref="Analyzer.Resolve"/> call so the ids a plan
...
/// </para>
/// <para>
/// The counter is intentionally <b>not</b> thread-safe: a single <see cref="Analyzer.Resolve"/> call
