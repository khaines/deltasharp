...
/// <see cref="EqualNullSafe(DeltaSharp.Column)"/>). Every operator is <b>lazy</b>: it only wraps a
/// new immutable expression node — no schema lookup, no evaluation, and (per AC4) <b>no</b>
